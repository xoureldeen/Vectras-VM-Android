...
public class VmAudioManager {
    ...
    public static void stream(String vmID) {
        ...
        streamAudio.setFile(VmFileManager.findAudioRaw(VectrasApp.getContext(), vmID));
        streamAudio.play();
    ...
    public static void set(String vmID) {
        currentVmId = vmID;
        streamAudio.setFile(VmFileManager.findAudioRaw(VectrasApp.getContext(), currentVmId));
    }
}
