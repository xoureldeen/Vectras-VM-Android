...
public class Config {
    ...
    // App Config
    public static final String downloadLink = "https://github.com/vectrasemu/vectras/wiki/Downloads";
    public static final String guidesLink = "https://github.com/vectrasemu/vectras/wiki/Guides";
    public static final String kvmLink = "https://github.com/vectrasemu/vectras/wiki/KVM";
    public static final String faqLink = "https://github.com/vectrasemu/vectras/wiki/FAQ";
    public static final String toolsLink = "https://github.com/vectrasemu/vectras/wiki/Tools";
    public static final String downloadUpdateLink = "https://raw.githubusercontent.com/vectrasemu/vectras/master/VERSION";
    ...
    public static final String datadirpath = MainActivityCommon.activity.getExternalFilesDir("data")+"/";
