...
//        View view = activity.getCurrentFocus();
    ...
    public static void onHelp(final Activity activity) {
        ...
        textView.setText("Welcome to Vectras Emulator, a port of QEMU for Android devices. " +
                "Vectras can emulate light weight operating systems by loading and running virtual disks images. " +
                "\n\nFor Downloads, Guides, Help, ISO, and Virtual Disk images visit the Vectras Wiki. " +
        ...
        checkUpdates.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                MainSettingsManager.setPromptUpdateVersion(activity, b);
            }
        });
		...
		alertDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "Don't Show Again",
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						MainSettingsManager.setPromptUpdateVersion(activity, false);
